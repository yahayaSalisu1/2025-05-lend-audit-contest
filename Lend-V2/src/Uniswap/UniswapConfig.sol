...
contract UniswapConfig {
    ...
    address internal immutable lToken00;
    address internal immutable lToken01;
    address internal immutable lToken02;
    address internal immutable lToken03;
    address internal immutable lToken04;
    address internal immutable lToken05;
    address internal immutable lToken06;
    address internal immutable lToken07;
    address internal immutable lToken08;
    address internal immutable lToken09;
    address internal immutable lToken10;
    address internal immutable lToken11;
    address internal immutable lToken12;
    address internal immutable lToken13;
    address internal immutable lToken14;
    address internal immutable lToken15;
    address internal immutable lToken16;
    address internal immutable lToken17;
    address internal immutable lToken18;
    address internal immutable lToken19;
    address internal immutable lToken20;
    address internal immutable lToken21;
    address internal immutable lToken22;
    address internal immutable lToken23;
    address internal immutable lToken24;
    address internal immutable lToken25;
    address internal immutable lToken26;
    address internal immutable lToken27;
    address internal immutable lToken28;
    ...
    function getReporterIndex(address reporter) internal view returns (uint256) {
    ...
    function getLTokenIndex(address lToken) internal view returns (uint256) {
        if (lToken == lToken00) return 0;
        if (lToken == lToken01) return 1;
        if (lToken == lToken02) return 2;
        if (lToken == lToken03) return 3;
        if (lToken == lToken04) return 4;
        if (lToken == lToken05) return 5;
        if (lToken == lToken06) return 6;
        if (lToken == lToken07) return 7;
        if (lToken == lToken08) return 8;
        if (lToken == lToken09) return 9;
        if (lToken == lToken10) return 10;
        if (lToken == lToken11) return 11;
        if (lToken == lToken12) return 12;
        if (lToken == lToken13) return 13;
        if (lToken == lToken14) return 14;
        if (lToken == lToken15) return 15;
        if (lToken == lToken16) return 16;
        if (lToken == lToken17) return 17;
        if (lToken == lToken18) return 18;
        if (lToken == lToken19) return 19;
        if (lToken == lToken20) return 20;
        if (lToken == lToken21) return 21;
        if (lToken == lToken22) return 22;
        if (lToken == lToken23) return 23;
        if (lToken == lToken24) return 24;
        if (lToken == lToken25) return 25;
        if (lToken == lToken26) return 26;
        if (lToken == lToken27) return 27;
        if (lToken == lToken28) return 28;
     ...
     * @return The config object
     */
    function getTokenConfigBySymbol(string calldata symbol) public view returns (TokenConfig memory) {
    ...
    /**
     * @notice Get the config for the lToken
     * @param lToken The address of the lToken of the config to get
     * @return The config object
     */
    function getTokenConfigByLToken(address lToken) public view returns (TokenConfig memory) {
        return getTokenConfig(getLTokenIndex(lToken));
    }
