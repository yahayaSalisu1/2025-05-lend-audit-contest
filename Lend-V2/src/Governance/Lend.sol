...
contract Lend {
    ...
    string public constant name = "Lend";
    ...
    uint256 public constant totalSupply = 10000000e18; // 10 million Lend
    ...
    function transferFrom(address src, address dst, uint256 rawAmount) external returns (bool) {
        ...
        if (spender != src && spenderAllowance != type(uint96).max) {
            uint96 newAllowance =
                sub96(spenderAllowance, amount, "Lend::transferFrom: transfer amount exceeds spender allowance");
